...
#include "../include/ArmNavigation.h"

ArmNavigation::ArmNavigation() {
...
void ArmNavigation::setArmsHappy()
{
...
/*
	arm_navigation_msgs::MoveArmAction movearm;

	ros::NodeHandle nh;

	ros::ServiceClient scene_client = nh.serviceClient<arm_navigation_msgs::SetPlanningSceneDiff>("/environment_server/set_planning_scene_diff");
